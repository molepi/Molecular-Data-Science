...
* Do diabetes have significantly different glucose levels compared to non-diabetics?
...
* A function that returns the correlation of all columns of FHS data with BMI.
