...
These introductory practicals are designed to teach you the basics of R. At the end, we expect you to be able to follow along with the other practicals of this course. Save your R-script or paste your answers in a Word document and mail it to l.j.sinke@lumc.nl.  
...
We can make use of this and create tables of variables in our data using `xtabs()` and `prop.table()`.  
...
You can see we can quickly build up attractive graphics in R. Subsetting can also be utilised within `ggplot2`.  
